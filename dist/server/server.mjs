export { default } from "file:///Users/bahar/Projects/marvel/node_modules/@nuxt/vite-builder/dist/runtime/vite-node.mjs", unref, version, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, readonly, onMounted, nextTick, watch, markRaw, defineComponent, createElementBlock, provide, h, Suspense, Fragment, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "characters-id",
    path: "/characters/:id()",
    component: () => import("./_nuxt/_id_-BL-VV944.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CiGb0Pjr.js")
  }
];
...
const primevue_plugin_eFEfcfXmoE = /* @__PURE__ */ defineNuxtPlugin(({ vueApp }) => {
  var _a;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-qFc4kIaq.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CpYvu9FM.js"));
